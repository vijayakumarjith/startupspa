...
import { AlertCircle, FileCheck, Users, Download } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mb-6">
            Click the "Sign in" button in the navigation bar to create your
            account and register your team. Make sure to review all rules and
